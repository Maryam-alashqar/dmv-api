...
<head>
    ...
    <title>{{ $supportTitleAr }} — DMV-Arabic</title>
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .email-card {
            ...
            background: #eaf4fc; border-radius: 10px; padding: 16px 20px;
            margin-bottom: 24px; text-align: center;
        }
        .email-card a {
            color: #0B84D8; font-weight: bold; font-size: 16px; text-decoration: none;
            direction: ltr;
        }
        .email-card a:hover { text-decoration: underline; }
...
<body>
    <div class="wrap">
        ...
        <section id="support">
            <h2>{{ $supportTitleAr }} — {{ $supportTitleEn }}</h2>
            <div class="lang-block">
                <span class="lang-label">العربية</span>
                <div class="content">{!! $supportContentAr !!}</div>
            </div>
            <div class="lang-block en">
                <span class="lang-label">English</span>
                <div class="content">{!! $supportContentEn !!}</div>
            </div>
        </section>
